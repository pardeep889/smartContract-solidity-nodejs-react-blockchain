...
describe('Lottery contract', () => {
    ...
    it('allows multiple account to enter', async() => {
     ...
     it('only manager can call pick winner function', async() => {
         try {
     ...
     it('send money to winners and empty the array of players', async() => {
        ...
        const diffrence = finalBalance - balance;
        // console.log("diffrence", diffrence, "finalBalance", finalBalance, "balance", balance);
